...
namespace Geometry {
    ...
    //Rock daughter volume
    const G4String  ROCK_MATERIAL = "Rock";
    const double ROCK_DAUGHTER_TOP = 0.5 * m;
    const double ROCK_DAUGHTER_BOTTOM = 0.5 * m;
    const double ROCK_DAUGHTER_SIDE = 0.5 * m;
    // Rock
    // const G4String  ROCK_MATERIAL = "Rock";
    ...
    // Rock daughter volume
    const double ROCK_DAUGHTER_W = HALL_D + 2 * ROCK_DAUGHTER_SIDE;
    const double ROCK_DAUGHTER_H = HALL_H + ROCK_DAUGHTER_TOP + ROCK_DAUGHTER_BOTTOM;
    // Rock
    ...
    const double ROCK_DAUGHTER_X = HALL_X;
    const double ROCK_DAUGHTER_Y = HALL_Y;
    const double ROCK_DAUGHTER_Z = HALL_Z + 0.5 * ROCK_DAUGHTER_TOP - 0.5 * ROCK_DAUGHTER_BOTTOM;
